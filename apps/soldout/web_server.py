...
# 리포 루트를 sys.path 에 추가 — 공유 패키지 scrapers/ 임포트용 (모노레포: apps/soldout/ 에서 실행)
# PyInstaller 번들에서는 scrapers 가 번들 루트에 포함되므로 불필요.
...
from scrapers.drug_data import SearchResult
